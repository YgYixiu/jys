export default {
  ...
  'footer': {
    ...
    'feedback': '问题反馈',
    'address': '新加坡© 2013-2020 Exmocoim',
    'about2': '公司简介',
    'service': '服务',
    'coin': '数字资产介绍',
  ...
  'home': {
    ...
    'android': 'Android',
    'pinput': '请输入你的邮箱',
    'atrade': '注册一个Exmocoim全球站账号 开始交易旅程',
    'Gcoin': 'Exmocoim',
    'eamil1': '商务合作邮箱',
    'eamil2': '客服邮箱',
    'kefu': '在线客服',
    ...
    'img2': '2_zh.png',
    'img3': '3_zh.png',
    'd1': 'Exmocoim 全球站，近24小时成交量<b>{number}</b>美元',
  ...
  'auth2': {
    ...
    'back': '证件照背面',
    'hand': '上传手持证件照',
    'tip2': '请提供一张您手持证件照的照片，在同张照片中也要包含有“Exmocoim”、日期和您的签名的注释。请确保您的脸部清晰可见，且所有证件详细信息都清楚可读',
    'face': '面部清晰可见无遮挡',
    'clearly': '照片清晰可见',
    'notes': '带有[Exmocoim]的文字注释',
    ...
    'tip4': ' 请提供一张您本人的Exmocoim账号的资产明细截图或者照片，图片中包含您的账户名、uid、持仓详情、当前时间。所有信息清晰可读。',
    'screenshot': '上传资产截图信息',
    'nowLever': '当前认证等级',
    'authCard': '身份证',
    'hu': '护照',
  ...
  'tpc': {
    ...
    'nodata': '暂无数据',
    'search': '搜索',
    'tips': '*当前页展示内容为项目方自行填写，Exmocoim不对此内容真实性负责',
    'time': '发行时间',
    'total': '发行总量',
    'circulation': '代币流通量',
    'price': '发行价',
  ...
  lockming: {
    ...
    forInstanceDesc:
      '会员在平台锁仓10000U，选择了周期为5天，日产出为锁仓金额的0.3%-0.4%的理财产品，则每天产出如下：<br />最低：10000U*0.3%=30U<br />最高：10000U*0.4%=40U<br />即5天后可以获得150U~200U的收益，收益每日下发，下发的收益可随时存取，锁仓本金到期后，自动转入您的资金账户。',
