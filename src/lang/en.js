export default {
  ...
  'welcome': 'Hi,Welcome to Exmocoim',
  'pwd': 'Password',
  'accounts': 'Account',
  'registers': 'Sign up',
  ...
  'footer': {
    ...
    'address': 'Singapore© 2013-2020 Exmocoim\t',
    'community': 'Community',
    'wechat': 'Wechat',
    'weibo': 'WeiBo',
  ...
  'home': {
    ...
    'img2': '2_en.png',
    'img3': '3_en.png',
    'd1': 'Exmocoim Global station, nearly 24 hours trading volume<b>{number}</b>USD',
  ...
  'login': {
    ...
    'welcome': 'Welcome Log in Exmocoim',
  ...
  'auth2': {
    ...
    'tip2': 'Please provide a photo of you with the card in your hand. In the same photo, should also include "Exmocoim", date and your signature. Please make sure that your face is visible and that all document details are readable',
    'face': 'The face is clearly visible without occlusion',
    'clearly': 'The photos are clearly visible',
    'notes': 'photo with [Exmocoim] text',
    ...
    'tip4': ' Please provide a screenshot or photo of the assets of your Exmocoim account, including your account name, uid, position details and current time. All the information is clearly readable.',
  ...
  'tpc': {
    ...
    'nodata': 'No data',
    'search': 'Search',
    'tips': '*The content displayed on the current page is filled out by the project party, and Exmocoim is not responsible for the authenticity of the content',
    'time': 'Issue time',
