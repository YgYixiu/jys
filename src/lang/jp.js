export default {
  ...
  'footer': {
    ...
    'email_pre': 'カスタマーサービス：',
    'address': 'シンガポール© 2013-2020 Exmocoim',
    'email': 'ビジネスメールアドレス',
    'feedback': '問題フィードバック',
    'about2': '会社の概要',
    'coin': 'デジタル資産の紹介',
  ...
  'home': {
    ...
    'atrade': 'Exmocoimグローバルステーションのアカウントを登録して、取引の旅を開始します。',
    'Gcoin': 'Exmocoim',
    ...
    'img2': '2_jp.png',
    'img3': '3_jp.png',
    'd1': 'Exmocoim Global，24時間の出来高<b>{number}</b>ドル',
  ...
  'auth2': {
    ...
    'tip2': '証明書を持って撮った写真を提供してください。同じ写真にも「Exmocoim」と日付とサインのコメントが含まれています。顔がよく見えるようにしてください。証明書の詳細は全部分かります',
    'face': '顔がくっきりと見える',
    'clearly': '写真が鮮明に見える',
    'notes': '[Exmocoim]の文字コメントが付いています',
    ...
    'tip4': ' ご本人のExmocoimアカウントの資産明細のスクリーンショットまたは写真を提供してください。画像にはお客様の口座名、uid、在庫保持の詳細、現在の時間が含まれています。すべての情報をクリアして読むことができます。',
  ...
  'tpc': {
    ...
    'nodata': 'データがありません',
    'search': '索',
    'tips': '*現在のページの展示内容はプロジェクト側自身で記入して、Exmocoimはこの内容の真実性に責任を負わない',
    'time': '発行時間',
    'total': '総発行量',
    'circulation': 'トークンフロー',
    'price': '発行価格',
  ...
  lockming: {
    ...
    forInstanceDesc:
      '会員はプラットフォームで100,000 Uをロックして、周期が5日で、日産はロック金額の0.3%-0.4%の財テク製品を出して、毎日以下のように産出します:<br/>最低:100,000 U*0.3%=30 U<br/>最高:10000 U*0.4%=40 U<br/>つまり5日後に150 U~200 Uの収益を得ることができて、収益は毎日下発して、下発の収益はいつでもアクセスすることができて、ロック元金が期限切れになった後、自動的にあなたの資金口座に振り込みます。',
    aboutLiquidatedDamages: '違約金について',
    aboutLiquidatedDamagesContent:
      '未満期の元金を転出したい場合は、違約金、違約金=違約決済比率*残存日数*ロック数量が発生します。<br/>例:このロック掘削の違約決算割合は0.4%で、残りの3日間は期限切れで、ロック数量は1000で、違約金=0.4%*3*1000=12 Uで、実際に元金を返却するのは1000 U-12 U=988 Uである。',
    joinNow: '私は参加します。',
    day: 'ああ',
    daily: '毎日',
